...
const ToolbarMessages = ({ avatar1, avatar2, avatar3, avatar4 }) => {
  const itemsCount = 4
  return (
    <CDropdown variant="nav-item" alignment="end">
      ...
      <CDropdownMenu className="pt-0">
        ...
        <CDropdownItem href="./">
          <div className="message">
            <div className="pt-3 me-3 float-start">
              <CAvatar src={avatar4} status="success" />
            </div>
            <div>
        ...
        <CDropdownItem href="./">
          <div className="message">
            <div className="pt-3 me-3 float-start">
              <CAvatar src={avatar3} status="warning" />
            </div>
            <div>
        ...
        <CDropdownItem href="./">
          <div className="message">
            <div className="pt-3 me-3 float-start">
              <CAvatar src={avatar2} status="danger" />
            </div>
            <div>
...
ToolbarMessages.propTypes = {
  avatar1: PropTypes.any,
  avatar2: PropTypes.any,
  avatar3: PropTypes.any,
  avatar4: PropTypes.any,
}
